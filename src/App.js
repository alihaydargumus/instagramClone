...
function App() {
    ...
    return (
        <div className="h-full w-full flex flex-wrap overflow-auto items-center gap-x-8 justify-center">
            <div
                className="hidden md:block w-[380px] h-[581px] relative bg-logo-pattern bg-[length:468.32px_634.15px] bg-[top_left_-46px]">
                <div className="w-[250px] h-[538px] absolute top-[27px] right-[18px]" ref={ref}>
                    <img
                        className="h-full w-full absolute top-0 left-0 opacity-0 transition-opacity duration-1000 ease-linear"
                ...
                <div className="bg-white border px-[40px] pt-8 pb-6">
                    ...
                    <form className="grid gap-y-1.5">
                        ...
                        <button type="submit" disabled={!enabled}
                                className="mt-1 h-[30px] bg-brand font-semibold text-white text-sm rounded disabled:opacity-50">Log
                            In
                        </button>
                        ...
                        <div>
                            ...
                            <a href="#" className="text-xs flex justify-center items-center gap-x-2 text-link">
                                Forget Password?
                            </a>
                        </div>
                    </form>
